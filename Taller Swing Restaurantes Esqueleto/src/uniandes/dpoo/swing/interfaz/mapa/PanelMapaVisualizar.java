...
public class PanelMapaVisualizar extends JPanel
{
    ...
    public void paint( Graphics g )
    {
     ...
     // TODO completar y hacer que se vean los nombres de todos los restaurantes en el mapa
        ...
        g2d.drawImage(((ImageIcon)labMapa.getIcon()).getImage(), 0, 0, null);
        
        if (restaurantes != null) {
        	for (int i = 0; i < restaurantes.size(); i++) {
        		
        		Restaurante restaurante = restaurantes.get(i);
        		String txtNombre = restaurante.getNombre();
        		//int[] coordenadas = ((PanelMapaAgregar) restaurante).getCoordenadas();
            	int coordenadaX = restaurante.getX();
            	int coordenadaY = restaurante.getY();
            	
            	g2d.setColor(Color.RED);
            	g2d.drawString(txtNombre, coordenadaX, coordenadaY);
        	}
        }
    }
