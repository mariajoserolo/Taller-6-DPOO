...
public class VentanaMapa extends JFrame implements ActionListener
{
    ...
    public VentanaMapa( VentanaPrincipal ventanaPrincipal, List<Restaurante> restaurantes )
    {
        ...
        JPanel PRestaurantes = new JPanel();
        radioTodos = new JRadioButton("TODOS");
        radioTodos.setActionCommand(TODOS);
        radioTodos.addActionListener(this);
        radioVisitados = new JRadioButton("VISITADOS");
        radioTodos.setActionCommand(VISITADOS);
        radioVisitados.addActionListener(this);
        
        PRestaurantes.add(radioTodos);
        PRestaurantes.add(radioVisitados);
        
        add(PRestaurantes, BorderLayout.SOUTH);
